...
const Projects = () => {
    ...
    const projectsData = [
        { title: 'AI Study Buddy', description: 'An interactive AI-powered study assistant built with Python and Streamlit to provide users with instant academic support.', tags: ['Python', 'Streamlit', 'NLP', 'AI/ML'], githubLink: 'https://github.com/saiimmani', icon: <Bot size={36}/> },
        { title: 'Crop Disease Prediction Model', description: 'Trained a CNN to distinguish common crop diseases with 95% validation accuracy. Implemented robust image preprocessing with OpenCV.', tags: ['Python', 'TensorFlow', 'OpenCV', 'CNN'], githubLink: 'https://github.com/saiimmani', icon: <Leaf size={36}/> },
        { title: 'Face Recognition Attendance System', description: 'A prototype for real-time attendance automation from a webcam feed, using an ML pipeline for face embedding and matching.', tags: ['Python', 'OpenCV', 'Scikit-learn', 'Tkinter'], githubLink: 'https://github.com/saiimmani', icon: <ScanFace size={36}/> },
        { title: 'Intelligent Fitness Tracker', description: "An intelligent fitness tracker desktop application built using Python's Tkinter GUI toolkit and Scikit-learn. It allows users to register/login, calculate BMI, receive personalized workout recommendations, log daily workout data, predict calorie burn trends using Linear Regression, and get expert fitness advice.", tags: ['Python', 'Tkinter', 'Scikit-learn', 'ML'], githubLink: 'https://github.com/saiimmani', icon: <HeartPulse size={36}/> },
    ];
